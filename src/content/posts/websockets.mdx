...
- **`Sec-WebSocket-Version: 13`** — The protocol version defined in [RFC 6455](https://datatracker.ietf.org/doc/html/rfc6455)
...
- [The WebSocket Handbook](https://websocketking.com/docs/) — Practical guide to WebSocket development
- [javascript.info: WebSocket](https://javascript.info/websocket) — Clear tutorial with examples
- [System Design: Chat Application](https://www.karanpratapsingh.com/courses/system-design/whatsapp#how-is-a-message-delivered) — How WhatsApp-scale messaging works
